...
description: "Learn how to create multiple dropdown sections in your documentation"
order: 2

# Multiple Navbar Sections

QuartoDocBuilder supports multiple dropdown sections in the navbar. This allows you to organize your documentation into logical categories like "Tutorials", "Explanation", and "How-to Guides".
